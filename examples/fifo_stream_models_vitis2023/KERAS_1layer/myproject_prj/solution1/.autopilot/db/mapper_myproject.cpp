...
unsigned int ap_apatb_layer5_out_cap_bc;
static AESL_RUNTIME_BC __xlx_layer5_out_V_size_Reader("../tv/stream_size/stream_size_out_layer5_out.dat");
using hls::sim::Byte;
struct __cosim_s20__ { char data[20]; };
struct __cosim_s2__ { char data[2]; };
struct __cosim_s32__ { char data[32]; };
extern "C" void myproject(__cosim_s20__*, __cosim_s2__*);
extern "C" void apatb_myproject_hw(volatile void * __xlx_apatb_param_input_1, volatile void * __xlx_apatb_param_layer5_out) {
using hls::sim::createStream;
auto* sinput_1 = createStream((hls::stream<__cosim_s20__>*)__xlx_apatb_param_input_1);
  //Create input buffer for layer5_out
  ap_apatb_layer5_out_cap_bc = __xlx_layer5_out_V_size_Reader.read_size();
  __cosim_s2__* __xlx_layer5_out_input_buffer= new __cosim_s2__[ap_apatb_layer5_out_cap_bc];
auto* slayer5_out = createStream((hls::stream<__cosim_s2__>*)__xlx_apatb_param_layer5_out);
  // DUT call
  myproject(sinput_1->data<__cosim_s20__>(), slayer5_out->data<__cosim_s2__>());
sinput_1->transfer((hls::stream<__cosim_s20__>*)__xlx_apatb_param_input_1);
slayer5_out->transfer((hls::stream<__cosim_s2__>*)__xlx_apatb_param_layer5_out);
}
