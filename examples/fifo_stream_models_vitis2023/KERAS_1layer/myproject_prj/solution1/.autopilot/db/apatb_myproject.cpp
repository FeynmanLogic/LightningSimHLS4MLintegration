...
#define WRAPC_STREAM_SIZE_OUT_layer5_out "../tv/stream_size/stream_size_out_layer5_out.dat"
#define WRAPC_STREAM_EGRESS_STATUS_layer5_out "../tv/stream_size/stream_egress_status_layer5_out.dat"
...
extern "C"
void apatb_myproject_hw(void* __xlx_apatb_param_input_1, void* __xlx_apatb_param_layer5_out)
{
  static hls::sim::Stream<hls::sim::Byte<20>> port0 {
    .width = 160,
    .name = "input_1",
#ifdef POST_CHECK
  ...
  port0.param = (hls::stream<hls::sim::Byte<20>>*)__xlx_apatb_param_input_1;
...
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_layer5_out),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_layer5_out),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_layer5_out),
#endif
  };
  port1.param = (hls::stream<hls::sim::Byte<2>>*)__xlx_apatb_param_layer5_out;
  port1.hasWrite = true;
  ...
  try {
    ...
    myproject_hw_stub_wrapper(__xlx_apatb_param_input_1, __xlx_apatb_param_layer5_out);
    port1.buffer();
