...
set Spec2ImplPortList { 
	layer6_out { ap_fifo {  { layer6_out_dout fifo_port_we 0 512 }  { layer6_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer6_out_fifo_cap fifo_update 0 2 }  { layer6_out_empty_n fifo_status 0 1 }  { layer6_out_read fifo_data 1 1 } } }
	layer7_out { ap_fifo {  { layer7_out_din fifo_port_we 1 512 }  { layer7_out_num_data_valid fifo_status_num_data_valid 0 2 }  { layer7_out_fifo_cap fifo_update 0 2 }  { layer7_out_full_n fifo_status 0 1 }  { layer7_out_write fifo_data 1 1 } } }
}
