...
// wrapc file define:
#define AUTOTB_TVIN_model_input "../tv/cdatafile/c.myproject.autotvin_model_input.dat"
#define WRAPC_STREAM_SIZE_IN_model_input "../tv/stream_size/stream_size_in_model_input.dat"
#define WRAPC_STREAM_INGRESS_STATUS_model_input "../tv/stream_size/stream_ingress_status_model_input.dat"
...
extern "C"
void apatb_myproject_hw(void* __xlx_apatb_param_model_input, void* __xlx_apatb_param_layer9_out)
{
  static hls::sim::Stream<hls::sim::Byte<32>> port0 {
    .width = 256,
    .name = "model_input",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_model_input),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_model_input),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_model_input),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_model_input),
#endif
  };
  port0.param = (hls::stream<hls::sim::Byte<32>>*)__xlx_apatb_param_model_input;
  ...
  port1.param = (hls::stream<hls::sim::Byte<10>>*)__xlx_apatb_param_layer9_out;
  port1.hasWrite = true;
  ...
  try {
    ...
    myproject_hw_stub_wrapper(__xlx_apatb_param_model_input, __xlx_apatb_param_layer9_out);
    port1.buffer();
