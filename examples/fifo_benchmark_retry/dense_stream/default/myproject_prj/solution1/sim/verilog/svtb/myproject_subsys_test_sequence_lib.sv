...
`ifndef MYPROJECT_SUBSYS_TEST_SEQUENCE_LIB__SV                                              
    ...
    `define AUTOTB_TVIN_model_input_model_input_TDATA  "../tv/cdatafile/c.myproject.autotvin_model_input.dat" 
    ...
    class myproject_subsys_test_sequence_lib extends uvm_sequence;                                
        ...
        virtual task body();                                                                        
            ...
            string file_queue_model_input [$];                                                         
            integer bitwidth_queue_model_input [$];                                                    
                                                                                                               
            svr_pkg::svr_master_sequence#(256) svr_port_model_input_seq;            
            svr_pkg::svr_random_sequence#(256) svr_port_random_port_model_input_seq;
            ...
            fork
                begin
                    fork
                        begin
                            string keystr_delay;
                            file_queue_model_input.push_back(`AUTOTB_TVIN_model_input_model_input_TDATA);
                            bitwidth_queue_model_input.push_back(256);

                            `uvm_create_on(svr_port_model_input_seq, p_sequencer.svr_port_model_input_sqr);
                            svr_port_model_input_seq.misc_if = refm.misc_if;
                            svr_port_model_input_seq.ap_done  = refm.ap_done_for_nexttrans ;
                            svr_port_model_input_seq.ap_ready = refm.ap_ready_for_nexttrans;
                            svr_port_model_input_seq.finish   = refm.finish;
                            svr_port_model_input_seq.file_rd.config_file(file_queue_model_input, bitwidth_queue_model_input);
                            if( refm.myproject_cfg.port_model_input_cfg.prt_type == AP_VLD ) wait(refm.misc_if.tb2dut_ap_start === 1'b1);
                            svr_port_model_input_seq.isusr_delay = svr_pkg::NO_DELAY;
                            `uvm_send(svr_port_model_input_seq);     
                        end                                               
                        begin
                            string keystr_delay;
                        ...
                        begin
                            wait(svr_port_model_input_seq);
                            forever begin
                                wait(svr_port_model_input_seq.one_sect_read);
                                svr_port_model_input_seq.one_sect_read = 0;
            ...
            p_sequencer.svr_port_model_input_sqr.stop_sequences();
