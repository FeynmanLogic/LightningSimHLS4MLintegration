...
`define AESL_DEPTH_model_input 1
`define AESL_DEPTH_layer9_out 1
`define AUTOTB_TVIN_model_input  "../tv/cdatafile/c.myproject.autotvin_model_input.dat"
`define AUTOTB_TVIN_model_input_out_wrapc  "../tv/rtldatafile/rtl.myproject.autotvin_model_input.dat"
`define AUTOTB_TVOUT_layer9_out  "../tv/cdatafile/c.myproject.autotvout_layer9_out.dat"
`define AUTOTB_TVOUT_layer9_out_out_wrapc  "../tv/rtldatafile/rtl.myproject.autotvout_layer9_out.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 5;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 1155;
parameter LENGTH_layer9_out = 1;
parameter LENGTH_model_input = 1;
...
wire ready;
wire ready_wire;
wire [255 : 0] model_input_TDATA;
wire [79 : 0] layer9_out_TDATA;
wire  model_input_TVALID;
wire  model_input_TREADY;
wire ap_start;
...
`AUTOTB_DUT `AUTOTB_DUT_INST(
    .model_input_TDATA(model_input_TDATA),
    .layer9_out_TDATA(layer9_out_TDATA),
    .ap_clk(ap_clk),
    .ap_rst_n(ap_rst_n),
    .model_input_TVALID(model_input_TVALID),
    .model_input_TREADY(model_input_TREADY),
    .ap_start(ap_start),
